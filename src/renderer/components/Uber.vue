  ...
  methods: {
    ...
    async submitForm () {
      ...
      do {
        let apiUrl
        if (nextToken) {
          apiUrl = `https://www.googleapis.com/gmail/v1/users/me/messages?pageToken=${nextToken}&q='{from:"Uber Receipts" from:"Reçu Uber" from:"Uber 收据" from:"Uber Fahrtinfo" from:"Recibos da Uber"} after:${startDate} before:${endDate}'`
        } else {
          apiUrl = `https://www.googleapis.com/gmail/v1/users/me/messages?q='{from:"Uber Receipts" from:"Reçu Uber" from:"Uber 收据" from:"Uber Fahrtinfo" from: "Recibos da Uber"} after:${startDate} before:${endDate}'`
        }
